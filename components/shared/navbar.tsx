...
export default function Navbar({ session }: { session: Session | null }) {
	...
	return (
		<nav className="relative bg-white">
			<div className="container px-6 py-3 mx-auto md:flex md:justify-between items-center">
				...
				<div className="relative">
					<button
						...
						className="flex items-center text-sm font-medium text-gray-900 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-100"
						onClick={() => setIsOpen(!isOpen)}
					>
