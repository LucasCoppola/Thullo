...
export default function Navbar({ session }: { session: Session | null }) {
	...
	return (
		<nav className="z-10 relative bg-transparent mt-1 px-6 md:px-10 shadow-sm">
			<div className="w-full py-2 flex justify-between items-center">
				...
				{board && (
					<div className="flex flex-row items-center">
						...
						<div className="mx-6 border-r border-gray-200 h-9 hidden md:block" />
						<Link href="/boards" className="hidden md:block">
				...
				<div className="flex">
					{session ? (
						<>
							{pathname !== '/' && <SearchBoardModal userId={session.userId} boardId={boardId} />}
